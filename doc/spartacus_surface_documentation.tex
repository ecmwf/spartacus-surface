...
\date{Document version 0.6.1 (February 2020) applicable to
  \spsurf\ version 0.6.1\thanks{This document is copyright
    \copyright\ European Centre for Medium Range Weather Forecasts
    2019. If you have any queries about \spsurf\ that are not answered
    by this document
%
...
\begin{center}
\textbf{The license conditions for \spsurf\ are under discussion at
  ECMWF, but for the moment you are not permitted to redistribute any
  part of the SPARTACUS-Surface code (modified or unmodified) outside
  your institute, or to use it for commercial purposes.}
\end{center}
